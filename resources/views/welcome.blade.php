            ...
            <div class="row">
              <div class="col-md-12">
                <div class="text-content">
                  <h2>Welcome To Studentloan </h2>
                  <div class="line-dec"></div>
                  {{-- <span>กองทุนให้กู้ยืมเพื่อการศึกษา &amp; เพื่อส่งงานจารย์ </span><br><br> --}}
                  <span>
                    <a href="{{ route('login') }}"  type="submit" class="btn btn-lg" style="background: blue; color: white">Login</a>
                    <a href="{{ route('register') }}"  type="submit" class="btn btn-lg"  style="background: green; color: white " >Register</a>
                  </span>
                </div>
